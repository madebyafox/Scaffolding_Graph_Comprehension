...
// }
var explicit = jsPsych.data.getURLVariable("E");
var impasse = jsPsych.data.getURLVariable("I");
var axis = jsPsych.data.getURLVariable("A");
var question = jsPsych.data.getURLVariable("Q");
//
...
var experiment = "2YP-3-ET"; //overriden by URL
...
var triangular_scaffolded = {
  ...
  timeline: [
      {on_start: function(){
          ...
          axis = axis;
          sid = sid;
          // appendQuery('http://localhost:3000/', { beep: 'boop' });
