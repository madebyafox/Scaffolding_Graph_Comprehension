...
var experiment = "reverse"; //overriden by URL
...
var linear_scaffolded = {
  ...
  on_finish: function(data) {
    ...
    console.log("LS"+(data.trial_index-20));
    console.log("finished: "+data.internal_node_id);
    console.log("correct? "+correct);
...
var linear_testing = {
  ...
  on_finish: function(data) {
    ...
    console.log("LT"+(data.trial_index-25));
    console.log("finished: "+data.internal_node_id);
    console.log("correct? "+correct);
  },
  timeline: [
...
var triangular_scaffolded = {
  ...
  on_finish: function(data) {
    ...
    console.log("TS"+(data.trial_index-4));
    console.log("finished: "+data.internal_node_id);
    console.log("correct? "+correct);
  },
  timeline: [
...
var triangular_testing = {
  ...
  on_finish: function(data) {
    ...
    console.log("TT"+(data.trial_index-9));
    console.log("finished: "+data.internal_node_id);
    console.log("correct? "+correct);
  },
  timeline: [
