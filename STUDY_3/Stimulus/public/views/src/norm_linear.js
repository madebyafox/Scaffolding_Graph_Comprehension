...
//NORMING FOR AXIS EXPERIMENTAL QUESTIONS
//RUNS ALL QUESTIONS IN 1 SCENARIO IN THE LINEAR model
...
var experiment = "norm_linear"; //overriden by URL
...
exp_timeline.push(instructions_turk); //0
exp_timeline.push(codes); //1
// // // // //LINEAR MODEL
exp_timeline.push(scenario_one); //2
exp_timeline.push(linear_scaffolded); //3-7  //linear with scaffold q 1-5
exp_timeline.push(linear_testing); //8-17  //linear without scaffold q 6-15
// // // //TRIANGULAR MODEL
