...
If we compare LM and TM scores in each scaffold condition (2-4) we will find that TM scores are higher than LM scores. 
...
Shows that differences are significant between 
control-interactive
tex1 - interactive, 
text-2 interactive
image-interactive
